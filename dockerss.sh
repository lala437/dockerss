...
install_dependencies(){
    if check_sys packageManager yum; then
        ...
        yum_depends=(
            ...
            autoconf automake make curl curl-devel zlib-devel perl perl-devel cpio expat-devel gettext-devel wget net-tools vim iputils-ping
        ...
        apt_depends=(
            ...
            autoconf automake libtool gcc make perl cpio libpcre3 libpcre3-dev zlib1g-dev libev-dev libc-ares-dev git qrencode wget net-tools vim iputils-ping
        )
...
install_prepare_cipher(){
 shadowsockscipher=$SS_CIPHER 
}

install_prepare_protocol(){
shadowsockprotocol=$SS_PROTOCOL
}

install_prepare_obfs(){
shadowsockobfs=$SS_OBFS
}

install_prepare_libev_obfs(){
  shadowsocklibev_obfs=$SS_LIBEV_OBFS  
}
